export const en = {
  ...
  exhibitionBanner: {
    prefix: "Meet GERGA at the exhibition — ",
    cta: "Stand Info & Meeting",
  },
  postExhibition: {
    tag: "SECTION 07 — POST-EXHIBITION CONVERSION",
    title: "Continue the conversation with GERGA.",
    subtitle: "Discover our B2B solutions and direct partnership opportunities tailored to your post-exhibition requirements.",
    options: {
      wholesale: "Products & Wholesale",
      wholesaleDesc: "Aegean Dried Fig selection & direct export supply.",
      sample: "Request Samples",
      sampleDesc: "Submit a sample request to evaluate our dried fig products.",
      distribution: "Distribution & Partnership",
      distributionDesc: "Regional distribution & long-term supply partnership.",
      saplings: "Saplings Proposal",
      saplingsDesc: "Certified true-to-type fig saplings for commercial production.",
      orchard: "Orchard Establishment",
      orchardDesc: "Turnkey commercial fig orchard setup & infrastructure.",
      consultancy: "Agricultural Consultancy",
      consultancyDesc: "On-site advisory for soil, climate, planting & management.",
    },
  },
  sampleRequest: {
    title: "Request Product Samples",
    subtitle: "Submit a sample request to evaluate GERGA Dried Fig products for your commercial projects.",
    fullName: "Full Name",
    ...
    productsList: [
      "Aegean Dried Figs (Aydın Sarılop)",
      "Mountain Dried Figs",
      "Industrial Fig Paste",
      "Custom Export Grade"
    ],
    estimatedVolume: "Estimated Commercial Volume (Optional)",
    message: "Your Message / Sample Details",
    privacyConsent: "I agree to the processing of my contact information for sample request communication.",
    submitBtn: "Request Product Samples",
    submitting: "Submitting...",
    successTitle: "Request Received",
    successMsg: "Your request will be reviewed by the GERGA team.",
    errorMsg: "An error occurred while submitting your sample request.",
  },
  offline: {
    connectionError: "We couldn't connect. Your information is still available on this screen. Check your connection and try again.",
    retry: "Retry",
  },
  catalogue: {
    navLink: "Digital Catalogue",
    title: "GERGA B2B Digital Corporate Catalogue",
    downloadPdf: "Print / Save as PDF",
    subtitle: "Aegean Dried Figs, Sapling Production, Orchard Establishment & Partnership Profile",
  },
