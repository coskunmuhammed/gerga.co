export const tr = {
  ...
  nav: {
    ...
    postExhibition: "İş Birliği",
    catalogue: "Dijital Katalog",
    gallery: "Galeri",
    contact: "İletişim",
    exhibitionBadge: "B2B Fuar Görüşmesi",
  },
  exhibitionBanner: {
    prefix: "GERGA ile fuarda buluşun — ",
    cta: "Stand Bilgisi ve Görüşme",
  },
  postExhibition: {
    tag: "BÖLÜM 07 — FUAR SONRASI DÖNÜŞÜM",
    title: "GERGA ile iş birliğini sürdürün.",
    subtitle: "Fuar sonrasında da ihtiyaçlarınıza uygun B2B çözümleri ve doğrudan iş birliği olanaklarımızı keşfedin.",
    options: {
      wholesale: "Ürün ve Toptan Satış",
      wholesaleDesc: "Ege Kuru İncir seçkisi ve doğrudan ihracat temini.",
      sample: "Numune Talebi",
      sampleDesc: "Kuru incir ürünlerimizi incelemek için numune başvurusu.",
      distribution: "Distribütörlük ve İş Birliği",
      distributionDesc: "Bölgesel distribütörlük ve uzun vadeli tedarik ortaklığı.",
      saplings: "Fidan Teklifi",
      saplingsDesc: "Ticari üretim için çeşide doğru sertifikalı incir fidanı.",
      orchard: "Bahçe Kurulumu",
      orchardDesc: "Anahtar teslim kapama incir bahçesi kurulumu ve altyapı.",
      consultancy: "Tarımsal Danışmanlık",
      consultancyDesc: "Toprak, iklim, dikim ve bakım süreçlerinde saha danışmanlığı.",
    },
  },
  sampleRequest: {
    ...
    productSelect: "Ürün Seçiniz...",
    productsList: [
      "Ege Kuru İncir (Aydın Sarılop)",
      "Dağ Kuru İnciri",
      "Endüstriyel İncir Ezmesi",
      "Özel İhracat Kalibresi"
    ],
    estimatedVolume: "Tahmini Ticari Alım Hacmi (Opsiyonel)",
    message: "Mesajınız / Numune Detayları",
    privacyConsent: "İletişim bilgilerimin numune talebi kapsamında işlenmesini onaylıyorum.",
    submitBtn: "Numune Talebi Oluştur",
    submitting: "Gönderiliyor...",
    successTitle: "Talebiniz Alındı",
    successMsg: "Talebiniz GERGA ekibi tarafından değerlendirilecektir.",
    errorMsg: "Numune talebi gönderilirken bir hata oluştu.",
  },
  offline: {
    connectionError: "Bağlantı kurulamadı. Bilgileriniz bu ekranda korunuyor. İnternet bağlantınızı kontrol ederek tekrar deneyin.",
    retry: "Yeniden Dene",
  },
  catalogue: {
    navLink: "Dijital Katalog",
    title: "GERGA B2B Dijital Kurumsal Katalog",
    downloadPdf: "PDF Olarak Yazdır / İndir",
    subtitle: "Ege İnciri, Fidan Üretimi, Kapama Bahçe Kurulumu & Tarımsal İş Birliği Profil Dokümanı",
  },
