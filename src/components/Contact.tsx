...
FN:GERGA Aegean Terroir Exhibition Desk
ORG:GERGA Agricultural Innovations
TITLE:International Trade & B2B Delegation
TEL;TYPE=WORK,VOICE:+908508854374
EMAIL;TYPE=WORK:exhibition@gerga.co
URL:https://gerga.co
ADR;TYPE=WORK:;;Büyük Menderes Basin;Aydın;İzmir;;Turkey
NOTE:Premium Aegean Agricultural Exhibition Presentation Card
END:VCARD`;
    ...
    link.href = url;
    link.setAttribute("download", "GERGA_Exhibition_Contact.vcf");
  ...
  return (
    <section id="contact" className="py-32 bg-[#090b09] relative border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        {/* B2B Exhibition Card & Contact Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          {/* Left Column: Digital Business Card with QR & vCard Download */}
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.8 }}
            className="lg:col-span-6 glass-card p-8 sm:p-10 rounded-3xl border border-[#d4af37]/40 relative overflow-hidden shadow-2xl"
          >
            ...
            {/* QR Code Simulation & Instructions */}
            <div className="grid grid-cols-1 sm:grid-cols-12 gap-6 items-center mb-8 bg-black/40 p-6 rounded-2xl border border-white/10">
              <div className="sm:col-span-5 flex flex-col items-center justify-center p-4 bg-white rounded-xl shadow-inner">
                ...
                <span className="mt-2 text-[9px] font-mono text-gray-700 tracking-wider font-bold">
                  SCAN FOR vCARD
                </span>
              </div>
              ...
              <div className="sm:col-span-7 flex flex-col justify-center">
                ...
                <button
                  ...
                  className="w-full py-3 rounded-xl bg-[#d4af37] text-black font-semibold text-xs uppercase tracking-wider hover:bg-[#e5c158] transition-all flex items-center justify-center gap-2 shadow-lg"
                >
            ...
            <a
              href="https://wa.me/908508854374?text=Hello%20GERGA%20Exhibition%20Team%2C%20I%20am%20interested%20in%20a%20B2B%20partnership."
              target="_blank"
              rel="noopener noreferrer"
              className="w-full py-3.5 rounded-xl border border-emerald-500/40 bg-emerald-500/10 text-emerald-400 hover:bg-emerald-500 hover:text-black font-semibold text-xs uppercase tracking-wider transition-all flex items-center justify-center gap-2"
            >
          ...
          {/* Right Column: Contact Details & Trade Fairs */}
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            ...
            <div className="glass-card p-6 rounded-2xl flex items-start gap-4">
              ...
              <div>
                ...
                <a
                  ...
                  className="font-serif text-lg text-[#d4af37] font-medium mt-1 block hover:underline"
                >
                  {dict.contact.email}
                </a>
              </div>
            ...
            <div className="glass-card p-6 rounded-2xl flex items-start gap-4">
              ...
              <div>
                ...
                <a
                  ...
                  className="font-serif text-lg text-white font-medium mt-1 block hover:text-[#d4af37]"
                >
                  {dict.contact.phone}
                </a>
              </div>
            ...
            {/* Trade Fair Badges Card */}
            <div className="glass-card p-6 rounded-2xl border border-white/10">
              <div className="flex items-center gap-2 mb-4">
                <Award className="w-4 h-4 text-[#d4af37]" />
                <span className="text-xs font-mono uppercase tracking-widest text-[#d4af37]">
                  {dict.contact.fairsTitle}
                </span>
              </div>
              <div className="flex flex-wrap gap-2">
                {dict.contact.fairs.map((fair, idx) => (
                  <span
                    key={idx}
